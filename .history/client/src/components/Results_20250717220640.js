...
const StatsBox = styled.div`
  ...
  border-radius: 20px;
  box-shadow: 0 2px 16px #d1ecff33;
  max-width: 350px;
  text-align: left;
  ...
  return (
    <>
      ...
      <ResultsContainer>
        ...
        <StatsBox>
          <StatTitle>나의 배드민턴 플레이 스타일</StatTitle>
          <StatRow>
            <StatLabel>현재 플레이 스타일</StatLabel>
            <StatValue>{userLabels.PlayStyle || '정보 없음'}</StatValue>
          </StatRow>
          <StatRow>
            <StatLabel>플레이 스타일 적합도</StatLabel>
            <StatValue>{statsData ? `${statsData.percentage}%` : 'N/A'}</StatValue>
          </StatRow>
          <StatRow>
            <StatLabel>평균 플레이 스타일 평점</StatLabel>
            <StatValue>{statsData ? `${statsData.rating}점` : 'N/A'}</StatValue>
          </StatRow>
          <StatRow>
            <StatLabel>플레이 스타일 만족도</StatLabel>
            <StatValue>{statsData ? `${statsData.stars}` : 'N/A'}</StatValue>
          </StatRow>
        </StatsBox>
      </UserProfileSection>
