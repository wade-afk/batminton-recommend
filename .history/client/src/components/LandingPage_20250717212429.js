    ...
    <MainContainer>
      ...
      <HorizontalContainer>
        ...
        <ExampleCard $bg="#f6fafc">
          ...
          <RacketType $color="#2186eb">공격형</RacketType>
          <RacketDescription>
            스매시 위주<br />
            강력 추천!
          </RacketDescription>
        ...
        <ExampleCard $bg="#f9f6fc">
          <RacketImage>🏸</RacketImage>
          <RacketType $color="#a340e2">수비형</RacketType>
          <RacketDescription>
            리턴 & 네트<br />
            최적화!
          </RacketDescription>
        ...
        {/* 사용자 후기 카드 */}
        <ReviewsContainer>
          <ReviewsTitle>💬 후기</ReviewsTitle>
          <UserReviewItem>
            <UserName>김**님</UserName>
            <ReviewText $color="#2186eb">공격형 추천! 🏸</ReviewText>
          </UserReviewItem>
          <UserReviewItem>
            <UserName>이**님</UserName>
            <ReviewText $color="#a340e2">수비형 추천! 🏸</ReviewText>
          </UserReviewItem>
          <UserReviewItem>
            <UserName>박**님</UserName>
            <ReviewText $color="#25C3B0">올라운드 추천! 🏸</ReviewText>
          </UserReviewItem>
        </ReviewsContainer>
      </HorizontalContainer>
