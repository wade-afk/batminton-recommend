...
function RacketSelector({ onCompare, onBack }) {
  ...
  useEffect(() => {
    ...
    const racketData = [
      { '종류': 'ARCSABER X7', ' 가격 ': '₩229,000', '출시날짜': '2025-03-12', '밸런스 포인트': '올라운더형(Even balance)', '무게': '4U', '원산지': 'TAIWAN', '샤프트 유연성': 'Flexible', '그립 사이즈': 'G5(81mm)', '색상': 'BEIGE', '적정 장력': '', '적용 소재 및 기술력': 'ISOMETRIC, Pocketing Booster, VDM, Nanometric DR, Control-Assist Bumper, Built-In-T-Joint, T-Anchor, Super HMG, Rexis, Super slim shaft, Control Support Cap', '특징': '올라운드형, 유연한 샤프트로 수비와 공격의 균형에 탁월함. 중상급자에게 적합.' },
